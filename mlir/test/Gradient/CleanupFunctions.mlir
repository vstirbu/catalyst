...
func.func private @f(%arg0: tensor<f64>) -> tensor<f64> attributes {qnode, diff_method = "parameter-shift"} {
    ...
    %2 = "quantum.custom"(%1) {gate_name = "Hadamard", operand_segment_sizes = array<i32: 0, 1, 0>, result_segment_sizes = array<i32: 1, 0> } : (!quantum.bit) -> !quantum.bit
    %3 = "quantum.extract"(%0, %c0_i64) : (!quantum.reg, i64) -> !quantum.bit
    %4 = tensor.extract %arg0[] : tensor<f64>
    %5:2 = "quantum.custom"(%4, %3, %2) {gate_name = "CRX", operand_segment_sizes = array<i32: 1, 2, 0>, result_segment_sizes = array<i32: 2, 0> } : (f64, !quantum.bit, !quantum.bit) -> (!quantum.bit, !quantum.bit)
...
func.func private @f2(%arg0: tensor<f64>, %arg1: tensor<i64>, %arg2: tensor<i64>) -> tensor<f64> attributes {qnode, diff_method = "parameter-shift"} {
    ...
    %2 = "quantum.custom"(%extracted, %1) {gate_name = "RX", operand_segment_sizes = array<i32: 1, 1, 0>, result_segment_sizes = array<i32: 1, 0> } : (f64, !quantum.bit) -> !quantum.bit
    %3 = "quantum.custom"(%2) {gate_name = "Hadamard", operand_segment_sizes = array<i32: 0, 1, 0>, result_segment_sizes = array<i32: 1, 0>} : (!quantum.bit) -> !quantum.bit
    ...
    %6 = scf.for %arg3 = %c1 to %5 step %c1 iter_args(%arg4 = %4) -> (!quantum.reg) {
        ...
        %12 = "quantum.custom"(%extracted_2, %11) {gate_name = "RX", operand_segment_sizes = array<i32: 1, 1, 0>, result_segment_sizes = array<i32: 1, 0>} : (f64, !quantum.bit) -> !quantum.bit
        ...
        %16:2 = "quantum.custom"(%14, %15) {gate_name = "CNOT", operand_segment_sizes = array<i32: 0, 2, 0>, result_segment_sizes = array<i32: 2, 0>} : (!quantum.bit, !quantum.bit) -> (!quantum.bit, !quantum.bit)
...
func.func private @f3(%arg0: tensor<f64>, %arg1: tensor<f64>) -> tensor<f64> attributes {qnode, diff_method = "parameter-shift"} {
    ...
    %3 = scf.if %extracted -> (!quantum.reg) {
        ...
        %10 = "quantum.custom"(%extracted_1, %9) {gate_name = "RX", operand_segment_sizes = array<i32: 1, 1, 0>, result_segment_sizes = array<i32: 1, 0>} : (f64, !quantum.bit) -> !quantum.bit
        ...
        %8 = "quantum.custom"(%extracted_1, %7) {gate_name = "RX", operand_segment_sizes = array<i32: 1, 1, 0>, result_segment_sizes = array<i32: 1, 0>} : (f64, !quantum.bit) -> !quantum.bit
